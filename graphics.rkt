...
(define color-func (multi-lerp rainbow-colors 10));(make-rgb 1 1 0) (make-rgb 0.52 0.15 0.08 )))
...
(define sample-julia-args (list DEPTH color-func (cons -0.533 0.524)))
; Cool Julia Sets
...
(define make-window
  (lambda ()
    ...
    (generate-fractal window WIDTH HEIGHT (set-zoom 0 ZOOM) 'complex 'julia-orbit-trap sample-julia-args)
